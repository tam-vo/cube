      ...
      callbackTimeoutId = setTimeout(function() {
        ...
        for (time in data) {
          ...
          if (emptyData) {
            ...
            hashTimeFrame["high"] = [hashTimeFrame["open"], hashTimeFrame["close"], hashTimeFrame["high"]].clean().max();
            hashTimeFrame["low"] = [hashTimeFrame["open"], hashTimeFrame["close"], hashTimeFrame["low"]].clean().min();
          }
          lastTime = time;
        }
        var lastValue = null;
